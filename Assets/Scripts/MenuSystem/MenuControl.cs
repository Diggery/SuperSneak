...
public class MenuControl : MonoBehaviour {
	...
	void Start () {
		...
		continueBackground = menuArt.transform.Find("ContinueBackground");
		...
		if (GameLoadSave.GetGameMapSeed() == -1) {
			...
			continueBackground.renderer.enabled = false;
		}
	}
